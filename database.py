...
class EntrepriseDatabase:
    def __init__(self, db_path=globals.DB_PATH):
    ...
    def get_entreprise_id_by_name(self, name):
        ...
        self.cursor.execute(
            "SELECT id FROM entreprises WHERE raison_sociale = ?", (name,)
        )
    ...
    def get_entreprise_juridique_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT forme_juridique FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def get_entreprise_capital_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT capital_social FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def get_entreprise_adresse_rue_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT adresse FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def get_entreprise_adresse_code_postal_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT code_postal FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def get_entreprise_adresse_ville_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT ville FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def get_entreprise_exercice_clos_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT fin_exercice FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def get_entreprise_name_by_id(self, entreprise_id):
        self.open_connection()
        self.cursor.execute(
            "SELECT raison_sociale FROM entreprises WHERE id = ?", (entreprise_id,)
        )
        result = self.cursor.fetchone()
        self.close()
        return result[0] if result else None
    ...
    def find_assembly(self, entreprise_id, exercice_clos, type):
        self.open_connection()
        self.cursor.execute(
            """SELECT * FROM plaquettes WHERE entreprise_id = ? AND 
                            exercice_clos = ? AND type = ?""",
            (entreprise_id, exercice_clos, type),
        )
        result = self.cursor.fetchone()
        self.close()
    ...
    def insert_empty_plaquette(self, entreprise_id):
        ...
        entreprise_name = (
            self.get_entreprise_juridique_by_id(entreprise_id)
            + " - "
            + self.get_entreprise_name_by_id(entreprise_id)
        )
